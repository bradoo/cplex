...
def solve_soft_capacity_network(demand_multiplier=1.25, unfulfilled_penalty=50):
    ...
    if solution is None:
        print("No solution found, even with unfulfilled demand allowed.")
        return
    ...
    for warehouse in warehouses:
        if open_warehouse[warehouse].solution_value > 0.5:
            ...
            print(
                ...
                f"{warehouses[warehouse]['capacity']}"
            )
