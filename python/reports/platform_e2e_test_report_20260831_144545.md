...
- 生成时间：`2026-08-31T14:45:45`
- 平台地址：`http://127.0.0.1:65524`
- 通过率：`100.0%`（16/16）
- 页面功能覆盖率：`100.0%`（26/26）
- 断言数：`15`
...
|---|---|---:|---:|---:|---|
| E2E01 | 页面导航与订单明细抽样展示 | PASS | 3 | 1936.67 | - |
| E2E02 | 上游业务表页面编辑保存回读 | PASS | 1 | 7714.57 | - |
| E2E03 | 场景配置传递到模型入参并高亮 | PASS | 2 | 6821.83 | - |
| E2E04 | 求解流水线进度与成本结构可视化 | PASS | 1 | 10493.24 | - |
| E2E05 | 审批通过与执行发布闭环 | PASS | 0 | 13436.25 | - |
| E2E06 | 运行历史报告与回放 | PASS | 0 | 6254.86 | - |
| E2E07 | 数据血缘与约束解释页面导航 | PASS | 0 | 535.86 | - |
| E2E08 | 压力测试与容量评估页面 | PASS | 0 | 11090.7 | - |
| E2E09 | 上游数据二级页面覆盖 | PASS | 1 | 1018.55 | - |
| E2E10 | 场景配置保存审计与权限 | PASS | 1 | 1119.22 | - |
| E2E11 | 四模型入参导航与重新生成 | PASS | 1 | 3613.24 | - |
| E2E12 | 结果页面板、三方案对比与报告导出 | PASS | 0 | 4671.07 | - |
| E2E13 | 角色权限隔离页面校验 | PASS | 0 | 340.88 | - |
| E2E14 | 审批驳回路径与发布拦截 | PASS | 0 | 11983.82 | - |
| E2E15 | 血缘多视图与四模型约束覆盖 | PASS | 1 | 624.64 | - |
| E2E16 | 上游到结果四步准确性链路 | PASS | 4 | 12331.38 | - |
...
{
  "run_id": "ce861eaa",
  "approval_status": "运行并保存记录后可发起审批。",
  "publish_status": "已发布：EXEC-20260831-ce861eaa-c87631，下游目标 4 个"
}
```
...
```json
{
  ...
  "replay_status": "已回放运行记录 bc2c6231，未新增运行记录。"
}
```
...
{
  "compare_rows": 10,
  "export_status": "已导出：python/reports/platform_report_20260831_144520_baseline.md",
...
{
  "run_id": "a7b5d282",
  "approval_status": "当前运行记录：a7b5d282，已驳回，当前角色：管理员",
