...
- 生成时间：`2026-08-31T13:35:15`
- 平台地址：`http://127.0.0.1:56580`
- 通过率：`100.0%`（16/16）
- 页面功能覆盖率：`100.0%`（25/25）
- 断言数：`15`
...
|---|---|---:|---:|---:|---|
| E2E01 | 页面导航与订单明细抽样展示 | PASS | 3 | 3870.25 | - |
| E2E02 | 上游业务表页面编辑保存回读 | PASS | 1 | 11790.79 | - |
| E2E03 | 场景配置传递到模型入参并高亮 | PASS | 2 | 9273.68 | - |
| E2E04 | 求解流水线进度与成本结构可视化 | PASS | 1 | 5061.38 | - |
| E2E05 | 审批通过与执行发布闭环 | PASS | 0 | 7740.42 | - |
| E2E06 | 运行历史报告与回放 | PASS | 0 | 10056.36 | - |
| E2E07 | 数据血缘与约束解释页面导航 | PASS | 0 | 7334.88 | - |
| E2E08 | 压力测试与容量评估页面 | PASS | 0 | 12331.23 | - |
| E2E09 | 上游数据二级页面覆盖 | PASS | 1 | 3845.61 | - |
| E2E10 | 场景配置保存审计与权限 | PASS | 1 | 4528.95 | - |
| E2E11 | 四模型入参导航与重新生成 | PASS | 1 | 6986.33 | - |
| E2E12 | 结果页面板、三方案对比与报告导出 | PASS | 0 | 5686.16 | - |
| E2E13 | 角色权限隔离页面校验 | PASS | 0 | 7605.45 | - |
| E2E14 | 审批驳回路径与发布拦截 | PASS | 0 | 5877.26 | - |
| E2E15 | 血缘多视图与四模型约束覆盖 | PASS | 1 | 7853.66 | - |
| E2E16 | 上游到结果四步准确性链路 | PASS | 4 | 15525.25 | - |
...
```json
{
  "approval_status": "当前运行记录：50e4b2e8，已批准，当前角色：管理员",
  "publish_status": "已发布：EXEC-20260831-50e4b2e8-53a310，下游目标 4 个"
}
```
...
```json
{
  ...
  "replay_status": "已回放运行记录 ec07b2d3，未新增运行记录。"
}
```
...
{
  "compare_rows": 10,
  "export_status": "已导出：python/reports/platform_report_20260831_133437_peak.md",
...
```json
{
  "approval_status": "当前运行记录：d27192e4，已驳回，当前角色：管理员",
